...
describe("priceOrder", () => {
  ...
  it("AC-26: понад межу — RangeError; рівно межа — рахується", () => {
    ...
    // рядку, обидва пройшли б. Тут IEEE-754 округлює суму на копійку **вниз**
    // (…981 → …980), і це нічого не міняє: похибка в один ulp з'являється аж за
    // 2⁵³, на шість порядків вище за межу.
